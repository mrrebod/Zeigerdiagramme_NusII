...
\ifWiderstandImWechselstromkreis{
	...
	\begin{flushright}
		...
		\begin{tikzpicture}	
			...
			%% Zeigerdiagramm %% 
			\draw[Spannungspfeil] (0,0)      -- ++(0:\USpitze) node[at start, above, blue]{$\hat{\underline{u}}$}; %Spannungspfeil
			\draw[Strompfeil]     (0,-0.1cm) -- ++(0:\ISpitze) node[at start, below, red] {$\hat{\underline{i}}$}; %Strompfeil
		\end{tikzpicture}
		%-----------------------------------------------------------------------------------------------------------------%	
