...
\begin{flushright}
	...
	\begin{tikzpicture}
		...
		\draw (90/\LenSca,\TickLen) rectangle (90/\LenSca,-\TickLen) node[scale = \BeschScale, below]{$\frac{\pi}{2}$};		
		\draw (180/\LenSca,\TickLen) rectangle (180/\LenSca,-\TickLen) node[scale = \BeschScale, below]{$\pi$};
		\draw (270/\LenSca,-\TickLen) rectangle (270/\LenSca,\TickLen) node[scale = \BeschScale, above]{$\frac{3\pi}{2}$};
		\draw (360/\LenSca,-\TickLen) rectangle (360/\LenSca,\TickLen) node[scale = \BeschScale, above]{$2\pi$};
	...
	\begin{tikzpicture}
		...
		\node[scale = \BeschScale, anchor = north east] at (0/\LenSca,0) {0};
		\draw (90/\LenSca,\TickLen) rectangle (90/\LenSca,-\TickLen) node[scale = \BeschScale, below]{$\frac{\pi}{2}$};		
		\draw (180/\LenSca,-\TickLen) rectangle (180/\LenSca,\TickLen) node[scale = \BeschScale, above]{$\pi$};
		\draw (270/\LenSca,-\TickLen) rectangle (270/\LenSca,\TickLen) node[scale = \BeschScale, above]{$\frac{3\pi}{2}$};
		\draw (360/\LenSca,-\TickLen) rectangle (360/\LenSca,\TickLen) node[scale = \BeschScale, above]{$2\pi$};
		% Pfeile der Phasenverschiebung 
