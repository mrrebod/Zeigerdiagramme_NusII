...
\begin{flushright}
		...
		\begin{tikzpicture}
			...
			\draw (270/\LenSca,\TickLen) -- (270/\LenSca,-\TickLen) node[scale = \BeschScale, below]{$\frac{3\pi}{2}$};
			...
			\node [anchor = north west] at (Ursprung) {\tiny{$\omega t_2$}};	
			% Hilfslinien
			...
			\draw[Winkelpfeil] ($(Ursprung) + (0:\USpitze+0.05cm)$) 
