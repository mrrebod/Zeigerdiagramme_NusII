...
\begin{flushright}
	...
	\begin{tikzpicture}
		...
		\draw[HelpLine] (end2) 	   -- ++(  0:1cm) node(help5) [HelpNode]{};
		
		\draw[HelpLine] (Ursprung) -- ++(0:\cosD+1cm) node(endx) [HelpNode]{}; % x-Achse
		...
		pic[pic text=$\varphi_1$, pic text options={scale=0.8}, draw, -{Latex[length=1mm]}, angle radius = 13mm, angle eccentricity=1.15]
